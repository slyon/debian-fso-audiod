/* alsa.c generated by valac 0.16.0, the Vala compiler
...
typedef struct _FsoAudioParamSpecBunchOfMixerControls FsoAudioParamSpecBunchOfMixerControls;
...
typedef struct _FsoAudioParamSpecMixerControl FsoAudioParamSpecMixerControl;
...
#define _snd_pcm_hw_params_free0(var) ((var == NULL) ? NULL : (var = (snd_pcm_hw_params_free (var), NULL)))
typedef struct _FsoAudioParamSpecPcmDevice FsoAudioParamSpecPcmDevice;
...
struct _FsoAudioParamSpecBunchOfMixerControls {
...
struct _FsoAudioSoundDevicePrivate {
	snd_ctl_t* card;
...
struct _FsoAudioParamSpecMixerControl {
	GParamSpec parent_instance;
};
...
struct _FsoAudioPcmDevicePrivate {
	gchar* name;
...
struct _FsoAudioParamSpecPcmDevice {
	GParamSpec parent_instance;
};


static gpointer fso_audio_bunch_of_mixer_controls_parent_class = NULL;
static gpointer fso_audio_sound_device_parent_class = NULL;
static gpointer fso_audio_mixer_control_parent_class = NULL;
static gpointer fso_audio_pcm_device_parent_class = NULL;
...
enum  {
	FSO_AUDIO_BUNCH_OF_MIXER_CONTROLS_DUMMY_PROPERTY
};
...
static FsoAudioMixerControl** _vala_array_dup3 (FsoAudioMixerControl** self, int length);
...
static void fso_audio_bunch_of_mixer_controls_finalize (FsoAudioBunchOfMixerControls* obj);
GType fso_audio_sound_device_get_type (void) G_GNUC_CONST;
#define FSO_AUDIO_SOUND_DEVICE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), FSO_AUDIO_TYPE_SOUND_DEVICE, FsoAudioSoundDevicePrivate))
enum  {
	FSO_AUDIO_SOUND_DEVICE_DUMMY_PROPERTY
};
static FsoAudioSoundDevice* fso_audio_sound_device_new (snd_ctl_t** card, snd_ctl_elem_list_t** list, const gchar* name, const gchar* fullname, const gchar* mixername, const gchar* cardname);
static FsoAudioSoundDevice* fso_audio_sound_device_construct (GType object_type, snd_ctl_t** card, snd_ctl_elem_list_t** list, const gchar* name, const gchar* fullname, const gchar* mixername, const gchar* cardname);
FsoAudioSoundDevice* fso_audio_sound_device_create (const gchar* cardname, GError** error);
static gchar* fso_audio_sound_device_real_repr (FsoFrameworkAbstractObject* base);
...
static void fso_audio_sound_device_finalize (GObject* obj);
enum  {
	FSO_AUDIO_MIXER_CONTROL_DUMMY_PROPERTY
};
...
static void fso_audio_mixer_control_finalize (FsoAudioMixerControl* obj);
...
#define FSO_AUDIO_PCM_DEVICE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), FSO_AUDIO_TYPE_PCM_DEVICE, FsoAudioPcmDevicePrivate))
enum  {
	FSO_AUDIO_PCM_DEVICE_DUMMY_PROPERTY
};
static void fso_audio_pcm_device_checkedCall (FsoAudioPcmDevice* self, const gchar* purpose, gint err, GError** error);
...
static void fso_audio_pcm_device_finalize (FsoAudioPcmDevice* obj);
...
GQuark fso_audio_sound_error_quark (void) {
	return g_quark_from_static_string ("fso_audio_sound_error-quark");
}
...
static FsoAudioMixerControl** _vala_array_dup3 (FsoAudioMixerControl** self, int length) {
	FsoAudioMixerControl** result;
	int i;
	result = g_new0 (FsoAudioMixerControl*, length + 1);
	for (i = 0; i < length; i++) {
		FsoAudioMixerControl* _tmp0_;
		_tmp0_ = _fso_audio_mixer_control_ref0 (self[i]);
		result[i] = _tmp0_;
	}
	return result;
}
...
FsoAudioBunchOfMixerControls* fso_audio_bunch_of_mixer_controls_construct (GType object_type, FsoAudioMixerControl** controls, int controls_length1, guint idxSpeakerVolume, guint idxMicVolume) {
	FsoAudioBunchOfMixerControls* self = NULL;
	FsoAudioMixerControl** _tmp0_;
	gint _tmp0__length1;
	FsoAudioMixerControl** _tmp1_;
	gint _tmp1__length1;
	guint _tmp2_;
	guint _tmp3_;
	self = (FsoAudioBunchOfMixerControls*) g_type_create_instance (object_type);
	_tmp0_ = controls;
	_tmp0__length1 = controls_length1;
	_tmp1_ = (_tmp0_ != NULL) ? _vala_array_dup3 (_tmp0_, _tmp0__length1) : ((gpointer) _tmp0_);
	_tmp1__length1 = _tmp0__length1;
	self->controls = (_vala_array_free (self->controls, self->controls_length1, (GDestroyNotify) fso_audio_mixer_control_unref), NULL);
	self->controls = _tmp1_;
	self->controls_length1 = _tmp1__length1;
	_tmp2_ = idxSpeakerVolume;
	self->idxSpeakerVolume = _tmp2_;
	_tmp3_ = idxMicVolume;
	self->idxMicVolume = _tmp3_;
	return self;
}


FsoAudioBunchOfMixerControls* fso_audio_bunch_of_mixer_controls_new (FsoAudioMixerControl** controls, int controls_length1, guint idxSpeakerVolume, guint idxMicVolume) {
	return fso_audio_bunch_of_mixer_controls_construct (FSO_AUDIO_TYPE_BUNCH_OF_MIXER_CONTROLS, controls, controls_length1, idxSpeakerVolume, idxMicVolume);
}
	...
	str = _tmp0_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				gboolean _tmp2_;
				gint _tmp4_;
				FsoAudioMixerControl** _tmp5_;
				gint _tmp5__length1;
				const gchar* _tmp6_;
				FsoAudioMixerControl** _tmp7_;
				gint _tmp7__length1;
				gint _tmp8_;
				FsoAudioMixerControl* _tmp9_;
				gchar* _tmp10_ = NULL;
				gchar* _tmp11_;
				gchar* _tmp12_ = NULL;
				gchar* _tmp13_;
				...
				_tmp10_ = fso_audio_mixer_control_to_string (_tmp9_);
				_tmp11_ = _tmp10_;
...
static void fso_audio_value_bunch_of_mixer_controls_init (GValue* value) {
	value->data[0].v_pointer = NULL;
}


static void fso_audio_value_bunch_of_mixer_controls_free_value (GValue* value) {
	if (value->data[0].v_pointer) {
		fso_audio_bunch_of_mixer_controls_unref (value->data[0].v_pointer);
	}
}


static void fso_audio_value_bunch_of_mixer_controls_copy_value (const GValue* src_value, GValue* dest_value) {
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = fso_audio_bunch_of_mixer_controls_ref (src_value->data[0].v_pointer);
	} else {
...
static gpointer fso_audio_value_bunch_of_mixer_controls_peek_pointer (const GValue* value) {
	return value->data[0].v_pointer;
}


static gchar* fso_audio_value_bunch_of_mixer_controls_collect_value (GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	if (collect_values[0].v_pointer) {
		FsoAudioBunchOfMixerControls* object;
		...
		value->data[0].v_pointer = fso_audio_bunch_of_mixer_controls_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar* fso_audio_value_bunch_of_mixer_controls_lcopy_value (const GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	FsoAudioBunchOfMixerControls** object_p;
	...
	if (!value->data[0].v_pointer) {
		...
		*object_p = fso_audio_bunch_of_mixer_controls_ref (value->data[0].v_pointer);
	}
	return NULL;
}
...
GParamSpec* fso_audio_param_spec_bunch_of_mixer_controls (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags) {
	FsoAudioParamSpecBunchOfMixerControls* spec;
	g_return_val_if_fail (g_type_is_a (object_type, FSO_AUDIO_TYPE_BUNCH_OF_MIXER_CONTROLS), NULL);
...
gpointer fso_audio_value_get_bunch_of_mixer_controls (const GValue* value) {
	g_return_val_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_BUNCH_OF_MIXER_CONTROLS), NULL);
	return value->data[0].v_pointer;
}


void fso_audio_value_set_bunch_of_mixer_controls (GValue* value, gpointer v_object) {
	FsoAudioBunchOfMixerControls* old;
	g_return_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_BUNCH_OF_MIXER_CONTROLS));
	old = value->data[0].v_pointer;
	if (v_object) {
		g_return_if_fail (G_TYPE_CHECK_INSTANCE_TYPE (v_object, FSO_AUDIO_TYPE_BUNCH_OF_MIXER_CONTROLS));
		g_return_if_fail (g_value_type_compatible (G_TYPE_FROM_INSTANCE (v_object), G_VALUE_TYPE (value)));
		value->data[0].v_pointer = v_object;
		fso_audio_bunch_of_mixer_controls_ref (value->data[0].v_pointer);
	} else {
		value->data[0].v_pointer = NULL;
	}
	if (old) {
		fso_audio_bunch_of_mixer_controls_unref (old);
	}
}
...
static void fso_audio_bunch_of_mixer_controls_class_init (FsoAudioBunchOfMixerControlsClass * klass) {
	fso_audio_bunch_of_mixer_controls_parent_class = g_type_class_peek_parent (klass);
	FSO_AUDIO_BUNCH_OF_MIXER_CONTROLS_CLASS (klass)->finalize = fso_audio_bunch_of_mixer_controls_finalize;
}


static void fso_audio_bunch_of_mixer_controls_instance_init (FsoAudioBunchOfMixerControls * self) {
	self->ref_count = 1;
}


static void fso_audio_bunch_of_mixer_controls_finalize (FsoAudioBunchOfMixerControls* obj) {
	FsoAudioBunchOfMixerControls * self;
	self = FSO_AUDIO_BUNCH_OF_MIXER_CONTROLS (obj);
	self->controls = (_vala_array_free (self->controls, self->controls_length1, (GDestroyNotify) fso_audio_mixer_control_unref), NULL);
}
 ...
 **/
GType fso_audio_bunch_of_mixer_controls_get_type (void) {
	static volatile gsize fso_audio_bunch_of_mixer_controls_type_id__volatile = 0;
	if (g_once_init_enter (&fso_audio_bunch_of_mixer_controls_type_id__volatile)) {
		static const GTypeValueTable g_define_type_value_table = { fso_audio_value_bunch_of_mixer_controls_init, fso_audio_value_bunch_of_mixer_controls_free_value, fso_audio_value_bunch_of_mixer_controls_copy_value, fso_audio_value_bunch_of_mixer_controls_peek_pointer, "p", fso_audio_value_bunch_of_mixer_controls_collect_value, "p", fso_audio_value_bunch_of_mixer_controls_lcopy_value };
		static const GTypeInfo g_define_type_info = { sizeof (FsoAudioBunchOfMixerControlsClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_audio_bunch_of_mixer_controls_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoAudioBunchOfMixerControls), 0, (GInstanceInitFunc) fso_audio_bunch_of_mixer_controls_instance_init, &g_define_type_value_table };
		static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
		GType fso_audio_bunch_of_mixer_controls_type_id;
		fso_audio_bunch_of_mixer_controls_type_id = g_type_register_fundamental (g_type_fundamental_next (), "FsoAudioBunchOfMixerControls", &g_define_type_info, &g_define_type_fundamental_info, 0);
		g_once_init_leave (&fso_audio_bunch_of_mixer_controls_type_id__volatile, fso_audio_bunch_of_mixer_controls_type_id);
	}
	return fso_audio_bunch_of_mixer_controls_type_id__volatile;
}
...
void fso_audio_bunch_of_mixer_controls_unref (gpointer instance) {
	...
	if (g_atomic_int_dec_and_test (&self->ref_count)) {
		FSO_AUDIO_BUNCH_OF_MIXER_CONTROLS_GET_CLASS (self)->finalize (self);
...
static FsoAudioSoundDevice* fso_audio_sound_device_construct (GType object_type, snd_ctl_t** card, snd_ctl_elem_list_t** list, const gchar* name, const gchar* fullname, const gchar* mixername, const gchar* cardname) {
	...
	self = (FsoAudioSoundDevice*) fso_framework_abstract_object_construct (object_type);
	_tmp0_ = *card;
	*card = NULL;
...
static FsoAudioSoundDevice* fso_audio_sound_device_new (snd_ctl_t** card, snd_ctl_elem_list_t** list, const gchar* name, const gchar* fullname, const gchar* mixername, const gchar* cardname) {
	return fso_audio_sound_device_construct (FSO_AUDIO_TYPE_SOUND_DEVICE, card, list, name, fullname, mixername, cardname);
}
...
/**
     ...
     **/
FsoAudioSoundDevice* fso_audio_sound_device_create (const gchar* cardname, GError** error) {
	FsoAudioSoundDevice* result = NULL;
	snd_ctl_t* card = NULL;
	const gchar* _tmp0_;
	...
	if (_tmp3_ < 0) {
		...
		_tmp7_ = _tmp6_;
		_tmp8_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_NO_DEVICE, _tmp7_);
		_tmp9_ = _tmp8_;
		_g_free0 (_tmp7_);
	...
	if (_tmp12_ < 0) {
		...
		_tmp16_ = _tmp15_;
		_tmp17_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp16_);
		_tmp18_ = _tmp17_;
		_g_free0 (_tmp16_);
	...
	if (_tmp22_ < 0) {
		...
		_tmp26_ = _tmp25_;
		_tmp27_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp26_);
		_tmp28_ = _tmp27_;
		_g_free0 (_tmp26_);
	...
	if (_tmp31_ < 0) {
		...
		_tmp35_ = _tmp34_;
		_tmp36_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp35_);
		_tmp37_ = _tmp36_;
		_g_free0 (_tmp35_);
	...
	if (_tmp41_ < 0) {
		...
		_tmp45_ = _tmp44_;
		_tmp46_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp45_);
		_tmp47_ = _tmp46_;
		_g_free0 (_tmp45_);
	...
	if (_tmp53_ < 0) {
		...
		_tmp57_ = _tmp56_;
		_tmp58_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp57_);
		_tmp59_ = _tmp58_;
		_g_free0 (_tmp57_);
	...
	if (_tmp63_ < 0) {
		...
		_tmp67_ = _tmp66_;
		_tmp68_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp67_);
		_tmp69_ = _tmp68_;
		_g_free0 (_tmp67_);
	...
	_tmp76_ = cardname;
	_tmp77_ = fso_audio_sound_device_new (&card, &list, _tmp71_, _tmp73_, _tmp75_, _tmp76_);
	result = _tmp77_;
	_snd_ctl_elem_list_free0 (list);
	_snd_ctl_card_info_free0 (info);
	_snd_ctl_close0 (card);
...
static gchar* fso_audio_sound_device_real_repr (FsoFrameworkAbstractObject* base) {
	FsoAudioSoundDevice * self;
	gchar* result = NULL;
	const gchar* _tmp0_;
	const gchar* _tmp1_ = NULL;
	gchar* _tmp2_ = NULL;
	self = (FsoAudioSoundDevice*) base;
	_tmp0_ = self->name;
...
FsoAudioMixerControl* fso_audio_sound_device_controlForId (FsoAudioSoundDevice* self, guint idx, GError** error) {
	FsoAudioMixerControl* result = NULL;
	...
	if (_tmp2_ < 0) {
		...
		_tmp6_ = _tmp5_;
		_tmp7_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp6_);
		_tmp8_ = _tmp7_;
		_g_free0 (_tmp6_);
	...
	if (_tmp15_ < 0) {
		...
		_tmp19_ = _tmp18_;
		_tmp20_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp19_);
		_tmp21_ = _tmp20_;
		_g_free0 (_tmp19_);
	...
	if (_tmp27_ < 0) {
		...
		_tmp31_ = _tmp30_;
		_tmp32_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp31_);
		_tmp33_ = _tmp32_;
		_g_free0 (_tmp31_);
	...
	if (_tmp36_ < 0) {
		...
		_tmp40_ = _tmp39_;
		_tmp41_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp40_);
		_tmp42_ = _tmp41_;
		_g_free0 (_tmp40_);
	...
	if (_tmp48_ < 0) {
		...
		_tmp52_ = _tmp51_;
		_tmp53_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp52_);
		_tmp54_ = _tmp53_;
		_g_free0 (_tmp52_);
	...
	_tmp55_ = fso_audio_mixer_control_new (&eid, &info, &value);
	result = _tmp55_;
	_snd_ctl_elem_value_free0 (value);
	_snd_ctl_elem_info_free0 (info);
	_snd_ctl_elem_id_free0 (eid);
...
void fso_audio_sound_device_setControl (FsoAudioSoundDevice* self, FsoAudioMixerControl* control, GError** error) {
	...
	if (_tmp3_ != SND_CTL_ELEM_TYPE_IEC958) {
		...
		if (_tmp8_ < 0) {
			...
			_tmp12_ = _tmp11_;
			_tmp13_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp12_);
			_tmp14_ = _tmp13_;
			_g_free0 (_tmp12_);
	...
	count = _tmp2_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				guint _tmp7_;
				gint _tmp8_;
				FsoAudioMixerControl* _tmp9_ = NULL;
				FsoAudioMixerControl* _tmp10_;
				FsoAudioMixerControl** _tmp11_;
				...
				_tmp8_ = i;
				_tmp9_ = fso_audio_sound_device_controlForId (self, (guint) _tmp8_, &_inner_error_);
				_tmp10_ = _tmp9_;
...
void fso_audio_sound_device_setAllMixerControls (FsoAudioSoundDevice* self, FsoAudioMixerControl** controls, int controls_length1, GError** error) {
	...
	_tmp0__length1 = controls_length1;
	{
		FsoAudioMixerControl** control_collection = NULL;
		...
		for (control_it = 0; control_it < _tmp0__length1; control_it = control_it + 1) {
			FsoAudioMixerControl* _tmp1_;
			FsoAudioMixerControl* control = NULL;
			_tmp1_ = _fso_audio_mixer_control_ref0 (control_collection[control_it]);
			control = _tmp1_;
			{
				FsoAudioMixerControl* _tmp2_;
				_tmp2_ = control;
				fso_audio_sound_device_setControl (self, _tmp2_, &_inner_error_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
						g_propagate_error (error, _inner_error_);
...
FsoAudioMixerControl* fso_audio_sound_device_controlForString (FsoAudioSoundDevice* self, const gchar* description, GError** error) {
	...
	gint _tmp23_;
	gint _tmp30_;
	FsoAudioMixerControl* _tmp31_ = NULL;
	FsoAudioMixerControl* control;
	FsoAudioMixerControl* _tmp32_;
	...
	if (_tmp3__length1 != 4) {
		...
		_tmp6_ = _tmp5_;
		_tmp7_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_INVALID_DESCRIPTOR, _tmp6_);
		_tmp8_ = _tmp7_;
		_g_free0 (_tmp6_);
		_inner_error_ = _tmp8_;
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
	...
	if (_tmp22__length1 != _tmp23_) {
		...
		_tmp27_ = _tmp26_;
		_tmp28_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_INVALID_DESCRIPTOR, _tmp27_);
		_tmp29_ = _tmp28_;
		_g_free0 (_tmp27_);
	...
	_tmp30_ = idx;
	_tmp31_ = fso_audio_sound_device_controlForId (self, (guint) (_tmp30_ - 1), &_inner_error_);
	control = _tmp31_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	switch (_tmp34_) {
		...
		default:
		{
			...
			_tmp98_ = _tmp97_;
			g_warning ("alsa.vala:263: %s", _tmp98_);
			_g_free0 (_tmp98_);
			break;
		}
	}
...
guint8 fso_audio_sound_device_volumeForIndex (FsoAudioSoundDevice* self, guint id) {
	...
	_tmp8_ = mel;
	if (_tmp8_ == NULL) {
		g_warning ("alsa.vala:284: mix.first_elem() returned NULL");
		result = (guint8) 0;
		_0 (mel);
		_snd_mixer_close0 (mix);
		return result;
...
void fso_audio_sound_device_setVolumeForIndex (FsoAudioSoundDevice* self, guint id, guint8 val) {
	...
	_tmp8_ = mel;
	if (_tmp8_ == NULL) {
		g_warning ("alsa.vala:317: mix.first_elem() returned NULL");
		_0 (mel);
		_snd_mixer_close0 (mix);
		return;
	}
...
static void fso_audio_sound_device_class_init (FsoAudioSoundDeviceClass * klass) {
	fso_audio_sound_device_parent_class = g_type_class_peek_parent (klass);
	g_type_class_add_private (klass, sizeof (FsoAudioSoundDevicePrivate));
	FSO_FRAMEWORK_ABSTRACT_OBJECT_CLASS (klass)->repr = fso_audio_sound_device_real_repr;
	G_OBJECT_CLASS (klass)->finalize = fso_audio_sound_device_finalize;
}


static void fso_audio_sound_device_instance_init (FsoAudioSoundDevice * self) {
	self->priv = FSO_AUDIO_SOUND_DEVICE_GET_PRIVATE (self);
}


static void fso_audio_sound_device_finalize (GObject* obj) {
	FsoAudioSoundDevice * self;
	self = FSO_AUDIO_SOUND_DEVICE (obj);
	_snd_ctl_close0 (self->priv->card);
	_snd_ctl_elem_list_free0 (self->priv->list);
	_g_free0 (self->name);
	_g_free0 (self->fullname);
	_g_free0 (self->mixername);
	_g_free0 (self->cardname);
	G_OBJECT_CLASS (fso_audio_sound_device_parent_class)->finalize (obj);
}
 ...
 **/
GType fso_audio_sound_device_get_type (void) {
	static volatile gsize fso_audio_sound_device_type_id__volatile = 0;
	if (g_once_init_enter (&fso_audio_sound_device_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (FsoAudioSoundDeviceClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_audio_sound_device_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoAudioSoundDevice), 0, (GInstanceInitFunc) fso_audio_sound_device_instance_init, NULL };
		GType fso_audio_sound_device_type_id;
		fso_audio_sound_device_type_id = g_type_register_static (FSO_FRAMEWORK_TYPE_ABSTRACT_OBJECT, "FsoAudioSoundDevice", &g_define_type_info, 0);
		g_once_init_leave (&fso_audio_sound_device_type_id__volatile, fso_audio_sound_device_type_id);
	}
	return fso_audio_sound_device_type_id__volatile;
}


FsoAudioMixerControl* fso_audio_mixer_control_construct (GType object_type, snd_ctl_elem_id_t** eid, snd_ctl_elem_info_t** info, snd_ctl_elem_value_t** value) {
	FsoAudioMixerControl* self = NULL;
	...
	self = (FsoAudioMixerControl*) g_type_create_instance (object_type);
	_tmp0_ = *eid;
	*eid = NULL;
...
FsoAudioMixerControl* fso_audio_mixer_control_new (snd_ctl_elem_id_t** eid, snd_ctl_elem_info_t** info, snd_ctl_elem_value_t** value) {
	return fso_audio_mixer_control_construct (FSO_AUDIO_TYPE_MIXER_CONTROL, eid, info, value);
}
...
static void fso_audio_value_mixer_control_init (GValue* value) {
	value->data[0].v_pointer = NULL;
}


static void fso_audio_value_mixer_control_free_value (GValue* value) {
	if (value->data[0].v_pointer) {
		fso_audio_mixer_control_unref (value->data[0].v_pointer);
	}
}


static void fso_audio_value_mixer_control_copy_value (const GValue* src_value, GValue* dest_value) {
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = fso_audio_mixer_control_ref (src_value->data[0].v_pointer);
	} else {
		dest_value->data[0].v_pointer = NULL;
	}
}
...
static gpointer fso_audio_value_mixer_control_peek_pointer (const GValue* value) {
	return value->data[0].v_pointer;
}


static gchar* fso_audio_value_mixer_control_collect_value (GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	if (collect_values[0].v_pointer) {
		FsoAudioMixerControl* object;
		object = collect_values[0].v_pointer;
		if (object->parent_instance.g_class == NULL) {
			return g_strconcat ("invalid unclassed object pointer for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
		...
		value->data[0].v_pointer = fso_audio_mixer_control_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar* fso_audio_value_mixer_control_lcopy_value (const GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	FsoAudioMixerControl** object_p;
	object_p = collect_values[0].v_pointer;
	if (!object_p) {
		return g_strdup_printf ("value location for `%s' passed as NULL", G_VALUE_TYPE_NAME (value));
	}
	if (!value->data[0].v_pointer) {
		...
		*object_p = fso_audio_mixer_control_ref (value->data[0].v_pointer);
	}
	return NULL;
}
...
GParamSpec* fso_audio_param_spec_mixer_control (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags) {
	FsoAudioParamSpecMixerControl* spec;
	g_return_val_if_fail (g_type_is_a (object_type, FSO_AUDIO_TYPE_MIXER_CONTROL), NULL);
	spec = g_param_spec_internal (G_TYPE_PARAM_OBJECT, name, nick, blurb, flags);
	G_PARAM_SPEC (spec)->value_type = object_type;
	return G_PARAM_SPEC (spec);
}
...
gpointer fso_audio_value_get_mixer_control (const GValue* value) {
	g_return_val_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_MIXER_CONTROL), NULL);
	return value->data[0].v_pointer;
}


void fso_audio_value_set_mixer_control (GValue* value, gpointer v_object) {
	FsoAudioMixerControl* old;
	g_return_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_MIXER_CONTROL));
	old = value->data[0].v_pointer;
	if (v_object) {
		g_return_if_fail (G_TYPE_CHECK_INSTANCE_TYPE (v_object, FSO_AUDIO_TYPE_MIXER_CONTROL));
		g_return_if_fail (g_value_type_compatible (G_TYPE_FROM_INSTANCE (v_object), G_VALUE_TYPE (value)));
		value->data[0].v_pointer = v_object;
		fso_audio_mixer_control_ref (value->data[0].v_pointer);
	} else {
		value->data[0].v_pointer = NULL;
	}
	if (old) {
		fso_audio_mixer_control_unref (old);
	}
}
...
static void fso_audio_mixer_control_class_init (FsoAudioMixerControlClass * klass) {
	fso_audio_mixer_control_parent_class = g_type_class_peek_parent (klass);
	FSO_AUDIO_MIXER_CONTROL_CLASS (klass)->finalize = fso_audio_mixer_control_finalize;
}


static void fso_audio_mixer_control_instance_init (FsoAudioMixerControl * self) {
	self->ref_count = 1;
}


static void fso_audio_mixer_control_finalize (FsoAudioMixerControl* obj) {
	FsoAudioMixerControl * self;
	self = FSO_AUDIO_MIXER_CONTROL (obj);
	_snd_ctl_elem_id_free0 (self->eid);
	_snd_ctl_elem_info_free0 (self->info);
	_snd_ctl_elem_value_free0 (self->value);
}
 ...
 **/
GType fso_audio_mixer_control_get_type (void) {
	static volatile gsize fso_audio_mixer_control_type_id__volatile = 0;
	if (g_once_init_enter (&fso_audio_mixer_control_type_id__volatile)) {
		static const GTypeValueTable g_define_type_value_table = { fso_audio_value_mixer_control_init, fso_audio_value_mixer_control_free_value, fso_audio_value_mixer_control_copy_value, fso_audio_value_mixer_control_peek_pointer, "p", fso_audio_value_mixer_control_collect_value, "p", fso_audio_value_mixer_control_lcopy_value };
		static const GTypeInfo g_define_type_info = { sizeof (FsoAudioMixerControlClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_audio_mixer_control_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoAudioMixerControl), 0, (GInstanceInitFunc) fso_audio_mixer_control_instance_init, &g_define_type_value_table };
		static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
		GType fso_audio_mixer_control_type_id;
		fso_audio_mixer_control_type_id = g_type_register_fundamental (g_type_fundamental_next (), "FsoAudioMixerControl", &g_define_type_info, &g_define_type_fundamental_info, 0);
		g_once_init_leave (&fso_audio_mixer_control_type_id__volatile, fso_audio_mixer_control_type_id);
	}
	return fso_audio_mixer_control_type_id__volatile;
}
...
void fso_audio_mixer_control_unref (gpointer instance) {
	...
	self = instance;
	if (g_atomic_int_dec_and_test (&self->ref_count)) {
		FSO_AUDIO_MIXER_CONTROL_GET_CLASS (self)->finalize (self);
		g_type_free_instance ((GTypeInstance *) self);
	}
}
...
static void fso_audio_pcm_device_checkedCall (FsoAudioPcmDevice* self, const gchar* purpose, gint err, GError** error) {
	...
	if (_tmp0_ < 0) {
		...
		_tmp6_ = g_strconcat ("Can't ", _tmp2_, ": ", _tmp5_, NULL);
		_tmp7_ = _tmp6_;
		_tmp8_ = g_error_new_literal (FSO_AUDIO_SOUND_ERROR, FSO_AUDIO_SOUND_ERROR_DEVICE_ERROR, _tmp7_);
		_tmp9_ = _tmp8_;
		_g_free0 (_tmp7_);
		_inner_error_ = _tmp9_;
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
...
void fso_audio_pcm_device_open (FsoAudioPcmDevice* self, const gchar* devicename, snd_pcm_stream_t mode, GError** error) {
	...
	gchar* _tmp3_;
	const gchar* _tmp4_;
	snd_pcm_stream_t _tmp5_;
	snd_pcm_t* _tmp6_ = NULL;
	gint _tmp7_ = 0;
	snd_pcm_t* _tmp8_;
	const gchar* _tmp9_;
	gchar* _tmp10_;
	snd_pcm_hw_params_t* _tmp11_ = NULL;
	GError * _inner_error_ = NULL;
	g_return_if_fail (self != NULL);
	g_return_if_fail (devicename != NULL);
	_tmp0_ = devicename;
	_tmp1_ = string_to_string (_tmp0_);
	_tmp2_ = g_strconcat ("open PCM device '", _tmp1_, "'", NULL);
	_tmp3_ = _tmp2_;
	_tmp4_ = devicename;
	_tmp5_ = mode;
	_tmp7_ = snd_pcm_open (&_tmp6_, _tmp4_, _tmp5_, 0);
	_0 (self->device);
	self->device = _tmp6_;
	fso_audio_pcm_device_checkedCall (self, _tmp3_, _tmp7_, &_inner_error_);
	_g_free0 (_tmp3_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
	...
	snd_pcm_hw_params_malloc (&_tmp11_);
	_snd_pcm_hw_params_free0 (self->priv->hwparams);
	self->priv->hwparams = _tmp11_;
}


void fso_audio_pcm_device_setFormat (FsoAudioPcmDevice* self, snd_pcm_access_t access, snd_pcm_format_t format, gint desiredrate, guint channels, GError** error) {
	gint _tmp0_;
	snd_pcm_access_t _tmp1_;
	snd_pcm_format_t _tmp2_;
	guint _tmp3_;
	snd_pcm_t* _tmp4_;
	snd_pcm_hw_params_t* _tmp5_;
	gint _tmp6_ = 0;
	snd_pcm_t* _tmp7_;
	snd_pcm_hw_params_t* _tmp8_;
	snd_pcm_access_t _tmp9_;
	gint _tmp10_ = 0;
	snd_pcm_t* _tmp11_;
	snd_pcm_hw_params_t* _tmp12_;
	snd_pcm_format_t _tmp13_;
	gint _tmp14_ = 0;
	snd_pcm_t* _tmp15_;
	snd_pcm_hw_params_t* _tmp16_;
	gint _tmp17_ = 0;
	snd_pcm_t* _tmp18_;
	snd_pcm_hw_params_t* _tmp19_;
	guint _tmp20_;
	gint _tmp21_ = 0;
	snd_pcm_t* _tmp22_;
	snd_pcm_hw_params_t* _tmp23_;
	gint _tmp24_ = 0;
	snd_pcm_t* _tmp25_;
	gint _tmp26_ = 0;
	GError * _inner_error_ = NULL;
	...
	_tmp1_ = access;
	self->priv->access = _tmp1_;
	_tmp2_ = format;
	self->priv->format = _tmp2_;
	_tmp3_ = channels;
	self->priv->channels = _tmp3_;
	_tmp4_ = self->device;
	_tmp5_ = self->priv->hwparams;
	_tmp6_ = snd_pcm_hw_params_any (_tmp4_, _tmp5_);
	fso_audio_pcm_device_checkedCall (self, "hw_params_any", _tmp6_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp7_ = self->device;
	_tmp8_ = self->priv->hwparams;
	_tmp9_ = access;
	_tmp10_ = snd_pcm_hw_params_set_access (_tmp7_, _tmp8_, _tmp9_);
	fso_audio_pcm_device_checkedCall (self, "hw_params_set_access", _tmp10_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp11_ = self->device;
	_tmp12_ = self->priv->hwparams;
	_tmp13_ = format;
	_tmp14_ = snd_pcm_hw_params_set_format (_tmp11_, _tmp12_, _tmp13_);
	fso_audio_pcm_device_checkedCall (self, "hw_params_set_format", _tmp14_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp15_ = self->device;
	_tmp16_ = self->priv->hwparams;
	_tmp17_ = snd_pcm_hw_params_set_rate_near (_tmp15_, _tmp16_, &self->priv->rate, 0);
	fso_audio_pcm_device_checkedCall (self, "hw_params_set_rate_near", _tmp17_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp18_ = self->device;
	_tmp19_ = self->priv->hwparams;
	_tmp20_ = channels;
	_tmp21_ = snd_pcm_hw_params_set_channels (_tmp18_, _tmp19_, _tmp20_);
	fso_audio_pcm_device_checkedCall (self, "hw_params_set_channels", _tmp21_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp22_ = self->device;
	_tmp23_ = self->priv->hwparams;
	_tmp24_ = snd_pcm_hw_params (_tmp22_, _tmp23_);
	fso_audio_pcm_device_checkedCall (self, "hw_params", _tmp24_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
	...
	_tmp25_ = self->device;
	_tmp26_ = snd_pcm_prepare (_tmp25_);
	fso_audio_pcm_device_checkedCall (self, "prepare", _tmp26_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
...
void fso_audio_pcm_device_close (FsoAudioPcmDevice* self) {
	...
	if (_tmp2_ < 0) {
		...
		_tmp8_ = g_strconcat ("Can't close opened PCM device '", _tmp4_, "': ", _tmp7_, NULL);
		_tmp9_ = _tmp8_;
		g_warning ("alsa.vala:465: %s", _tmp9_);
		_g_free0 (_tmp9_);
	}
}
...
void fso_audio_pcm_device_prepare (FsoAudioPcmDevice* self, GError** error) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = self->device;
	_tmp1_ = snd_pcm_prepare (_tmp0_);
	fso_audio_pcm_device_checkedCall (self, "prepare", _tmp1_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == FSO_AUDIO_SOUND_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
...
snd_pcm_sframes_t fso_audio_pcm_device_writei (FsoAudioPcmDevice* self, guint8* buf, int buf_length1, snd_pcm_uframes_t size, GError** error) {
	...
	guint8* _tmp1_;
	gint _tmp1__length1;
	snd_pcm_uframes_t _tmp2_;
	snd_pcm_sframes_t _tmp3_ = {0};
	g_return_val_if_fail (self != NULL, result);
	_tmp0_ = self->device;
	_tmp1_ = buf;
	_tmp1__length1 = buf_length1;
	_tmp2_ = size;
	_tmp3_ = snd_pcm_writei (_tmp0_, _tmp1_, _tmp2_);
	result = _tmp3_;
	return result;
}
...
snd_pcm_sframes_t fso_audio_pcm_device_writen (FsoAudioPcmDevice* self, guint8** buf, int buf_length1, snd_pcm_uframes_t size, GError** error) {
	...
	_tmp1__length1 = buf_length1;
	_tmp2_ = size;
	_tmp3_ = snd_pcm_writen (_tmp0_, _tmp1_, _tmp2_);
	result = _tmp3_;
	return result;
}
...
snd_pcm_sframes_t fso_audio_pcm_device_readi (FsoAudioPcmDevice* self, guint8* buf, int buf_length1, snd_pcm_uframes_t size, GError** error) {
	...
	_tmp1__length1 = buf_length1;
	_tmp2_ = size;
	_tmp3_ = snd_pcm_readi (_tmp0_, _tmp1_, _tmp2_);
	result = _tmp3_;
	return result;
}
...
snd_pcm_sframes_t fso_audio_pcm_device_readn (FsoAudioPcmDevice* self, guint8** buf, int buf_length1, snd_pcm_uframes_t size, GError** error) {
	...
	_tmp1__length1 = buf_length1;
	_tmp2_ = size;
	_tmp3_ = snd_pcm_readn (_tmp0_, _tmp1_, _tmp2_);
	result = _tmp3_;
	return result;
}
...
gint fso_audio_pcm_device_recover (FsoAudioPcmDevice* self, gint _error_, gint silent) {
	...
	_tmp1_ = _error_;
	_tmp2_ = silent;
	_tmp3_ = snd_pcm_recover (_tmp0_, _tmp1_, _tmp2_);
	result = _tmp3_;
	return result;
}
...
FsoAudioPcmDevice* fso_audio_pcm_device_construct (GType object_type) {
	FsoAudioPcmDevice* self = NULL;
	self = (FsoAudioPcmDevice*) g_type_create_instance (object_type);
	return self;
}


FsoAudioPcmDevice* fso_audio_pcm_device_new (void) {
	return fso_audio_pcm_device_construct (FSO_AUDIO_TYPE_PCM_DEVICE);
}


static void fso_audio_value_pcm_device_init (GValue* value) {
	value->data[0].v_pointer = NULL;
}


static void fso_audio_value_pcm_device_free_value (GValue* value) {
	if (value->data[0].v_pointer) {
		fso_audio_pcm_device_unref (value->data[0].v_pointer);
	}
}


static void fso_audio_value_pcm_device_copy_value (const GValue* src_value, GValue* dest_value) {
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = fso_audio_pcm_device_ref (src_value->data[0].v_pointer);
	} else {
		dest_value->data[0].v_pointer = NULL;
	}
}
...
static gpointer fso_audio_value_pcm_device_peek_pointer (const GValue* value) {
	return value->data[0].v_pointer;
}


static gchar* fso_audio_value_pcm_device_collect_value (GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	if (collect_values[0].v_pointer) {
		FsoAudioPcmDevice* object;
		object = collect_values[0].v_pointer;
		if (object->parent_instance.g_class == NULL) {
			return g_strconcat ("invalid unclassed object pointer for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
		...
		value->data[0].v_pointer = fso_audio_pcm_device_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar* fso_audio_value_pcm_device_lcopy_value (const GValue* value, guint n_collect_values, GTypeCValue* collect_values, guint collect_flags) {
	FsoAudioPcmDevice** object_p;
	object_p = collect_values[0].v_pointer;
	if (!object_p) {
		return g_strdup_printf ("value location for `%s' passed as NULL", G_VALUE_TYPE_NAME (value));
	}
	if (!value->data[0].v_pointer) {
		...
		*object_p = fso_audio_pcm_device_ref (value->data[0].v_pointer);
	}
	return NULL;
}
...
GParamSpec* fso_audio_param_spec_pcm_device (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags) {
	FsoAudioParamSpecPcmDevice* spec;
	g_return_val_if_fail (g_type_is_a (object_type, FSO_AUDIO_TYPE_PCM_DEVICE), NULL);
	spec = g_param_spec_internal (G_TYPE_PARAM_OBJECT, name, nick, blurb, flags);
	G_PARAM_SPEC (spec)->value_type = object_type;
	return G_PARAM_SPEC (spec);
}
...
gpointer fso_audio_value_get_pcm_device (const GValue* value) {
	g_return_val_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_PCM_DEVICE), NULL);
	return value->data[0].v_pointer;
}


void fso_audio_value_set_pcm_device (GValue* value, gpointer v_object) {
	FsoAudioPcmDevice* old;
	g_return_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, FSO_AUDIO_TYPE_PCM_DEVICE));
	old = value->data[0].v_pointer;
	if (v_object) {
		g_return_if_fail (G_TYPE_CHECK_INSTANCE_TYPE (v_object, FSO_AUDIO_TYPE_PCM_DEVICE));
		g_return_if_fail (g_value_type_compatible (G_TYPE_FROM_INSTANCE (v_object), G_VALUE_TYPE (value)));
		value->data[0].v_pointer = v_object;
		fso_audio_pcm_device_ref (value->data[0].v_pointer);
	} else {
		value->data[0].v_pointer = NULL;
	}
	if (old) {
		fso_audio_pcm_device_unref (old);
	}
}
...
static void fso_audio_pcm_device_class_init (FsoAudioPcmDeviceClass * klass) {
	fso_audio_pcm_device_parent_class = g_type_class_peek_parent (klass);
	FSO_AUDIO_PCM_DEVICE_CLASS (klass)->finalize = fso_audio_pcm_device_finalize;
	g_type_class_add_private (klass, sizeof (FsoAudioPcmDevicePrivate));
}


static void fso_audio_pcm_device_instance_init (FsoAudioPcmDevice * self) {
	self->priv = FSO_AUDIO_PCM_DEVICE_GET_PRIVATE (self);
	self->ref_count = 1;
}


static void fso_audio_pcm_device_finalize (FsoAudioPcmDevice* obj) {
	FsoAudioPcmDevice * self;
	self = FSO_AUDIO_PCM_DEVICE (obj);
	_g_free0 (self->priv->name);
	_0 (self->device);
	_snd_pcm_hw_params_free0 (self->priv->hwparams);
}
 ...
 **/
GType fso_audio_pcm_device_get_type (void) {
	static volatile gsize fso_audio_pcm_device_type_id__volatile = 0;
	if (g_once_init_enter (&fso_audio_pcm_device_type_id__volatile)) {
		static const GTypeValueTable g_define_type_value_table = { fso_audio_value_pcm_device_init, fso_audio_value_pcm_device_free_value, fso_audio_value_pcm_device_copy_value, fso_audio_value_pcm_device_peek_pointer, "p", fso_audio_value_pcm_device_collect_value, "p", fso_audio_value_pcm_device_lcopy_value };
		static const GTypeInfo g_define_type_info = { sizeof (FsoAudioPcmDeviceClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) fso_audio_pcm_device_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (FsoAudioPcmDevice), 0, (GInstanceInitFunc) fso_audio_pcm_device_instance_init, &g_define_type_value_table };
		static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
		GType fso_audio_pcm_device_type_id;
		fso_audio_pcm_device_type_id = g_type_register_fundamental (g_type_fundamental_next (), "FsoAudioPcmDevice", &g_define_type_info, &g_define_type_fundamental_info, 0);
		g_once_init_leave (&fso_audio_pcm_device_type_id__volatile, fso_audio_pcm_device_type_id);
	}
	return fso_audio_pcm_device_type_id__volatile;
}
...
void fso_audio_pcm_device_unref (gpointer instance) {
	...
	self = instance;
	if (g_atomic_int_dec_and_test (&self->ref_count)) {
		FSO_AUDIO_PCM_DEVICE_GET_CLASS (self)->finalize (self);
		g_type_free_instance ((GTypeInstance *) self);
	}
}
